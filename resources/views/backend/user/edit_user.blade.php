                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_user" value="{{$user->nama_user}}"  class="form-control" placeholder="Nama">
                                    @error('nama_user')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_tlpn" value="{{$user->no_tlpn}}"  class="form-control" placeholder="No. Telepon">
                                    @error('no_tlpn')
                                    <i class="text-danger">{{$message}}</i>
                                    @enderror
                                </div>
